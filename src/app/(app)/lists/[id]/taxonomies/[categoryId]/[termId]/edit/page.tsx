...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `${t('taxonomy.page.edit_term.title')} | ${t('messages.common.base_title')}`,
  };
}

export default async function TaxonomyTermEditPage({params}: {params: Promise<{id: string; categoryId: string; termId: string}>}): Promise<ReactElement> {
  const t = await getTranslations();
  ...
  return (
    <AppsSimpleContainer
      title={[
        ...
        t('taxonomy.page.edit_term.title'),
      ]}
      hasMaxWidth
    >
      <Content/>
