...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `${t('taxonomy.page.categories.title')} | ${t('messages.common.base_title')}`,
  };
}

export default function TaxonomyCategoriesPage(): ReactElement {
  ...
  return (
    <AppsSimpleContainer
      title={[
        ...
        t('taxonomy.page.categories.title'),
      ]}
      hasMaxWidth
    >
      <Content/>
